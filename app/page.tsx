    ...
    <div className="min-h-screen bg-[#fff9ec] text-[#2a241f]">
      ...
      <main className="mx-auto max-w-5xl px-6 pb-24 pt-12 text-center">
        ...
        <div id="download" className="mt-8 flex flex-wrap justify-center gap-3">
          <a
            href="https://github.com/ssongssu37/studybanana-website/releases/download/v1.0.1/StudyBanana-1.0.0.dmg"
          ...
          <a
            href="https://github.com/ssongssu37/studybanana-website/releases/download/v1.0.1/StudyBanana.Setup.1.0.0.exe"
          ...
          <div className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-3">
            ...
            <div className="rounded-2xl border border-black/8 bg-white p-7 text-left shadow-sm">
              ...
              <ul className="space-y-2 text-sm text-black/60 mb-8">
                {['Clock & Notes','Pomodoro timer','2 themes (Daylight Amber + Linen)','Offline access','Parental lock 🔒'].map(f=>(
        ...
        <div className="mt-24 rounded-3xl bg-[#2a241f] px-8 py-14 text-white">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            <a href="https://github.com/ssongssu37/studybanana-website/releases/download/v1.0.1/StudyBanana-1.0.0.dmg" className="rounded-full bg-[#ffd54f] px-7 py-3 text-base font-semibold text-[#2a241f] transition hover:-translate-y-0.5">
              Download for Mac
            </a>
            <a href="https://github.com/ssongssu37/studybanana-website/releases/download/v1.0.1/StudyBanana.Setup.1.0.0.exe" className="rounded-full border border-white/20 px-7 py-3 text-base font-medium text-white transition hover:bg-white/10">
              Download for Windows
            </a>
          </div>
        </div>
